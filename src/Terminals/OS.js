...
const initializeLocalStorage = () => {
  let tree = localStorage.getItem("kalina-files");
  if (tree !== null) return;
...
const saveData = (tree) => {
  ...
  localStorage.setItem("kalina-files", stringFileStructure);
};
...
export default class OS extends React.Component {
  ...
  terminalString = this.user + "kalina@boksa:~$ ";

  constructor(props) {
    super(props);
    initializeLocalStorage();
    this.tree = JSON.parse(localStorage.getItem("kalina-files"));
